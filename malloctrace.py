...
if len(sys.argv) < 3:
    print("USAGE: malloctrace PID BIN [NUM_STACKS=1024]")
    exit()
pid = int(sys.argv[1])
...
b.attach_uprobe(name=binary, sym="malloc", fn_name="alloc_enter", pid=pid)
...
print("!!!! stack_traces {}".format(len(stack_traces)))
